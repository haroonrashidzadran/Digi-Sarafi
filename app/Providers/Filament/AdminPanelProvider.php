...
use App\Filament\Widgets\CashPositionWidget;
use App\Filament\Widgets\TransferStatsWidget;
use App\Filament\Widgets\ProfitLossWidget;
use App\Filament\Widgets\PartnerBalanceWidget;
...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->pages([
                \App\Filament\Pages\SarafiDashboard::class,
            ])
            ->discoverWidgets(in: app_path('Filament/Widgets'), for: 'App\Filament\Widgets')
            ->widgets([
                AccountWidget::class,
                CashPositionWidget::class,
